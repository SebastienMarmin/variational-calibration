...
class TransformedDistribution(Distribution):
    ...
    :class:`~.gumbel.Gumbel`,
    :class:`~.half_cauchy.HalfCauchy`,
    :class:`~.half_normal.HalfNormal`,
    :class:`~.log_normal.LogNormal`,
    :class:`~.pareto.Pareto`,
    :class:`~.weibull.Weibull`,
    :class:`~.relaxed_bernoulli.RelaxedBernoulli` and
    :class:`~.relaxed_categorical.RelaxedOneHotCategorical`
    """
    arg_constraints = {}
