...
parameters, we only need :meth:`~.Distribution.sample` and
:meth:`~.Distribution.log_prob` to implement REINFORCE:
...
:meth:`~.Distribution.rsample` method, where the
...
from .multi_tensor_variate import MultiTensorVariate
